...
export default function Footer(){
    return(
        <footer className="w-full h-full shadow-2xl p-6 text-white flex flex-col-reverse items-center justify-center px-2 md:px-8 " style={{ backgroundColor: '#2F2E3A' }}>
            <p className="text-lg mt-2">© 2023 Pedro Marques. All rights reserved.</p>
